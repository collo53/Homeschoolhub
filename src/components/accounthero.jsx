      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="border rounded-lg p-6 bg-white shadow-sm">
            ...
            <div className="mb-4">
              ...
              <button className="border border-slate-300 px-4 py-2 rounded hover:bg-slate-100 transition">Enable 2FA</button>
            </div>

            <button className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">Update Password</button>
          </div>
        </div>
        ...
        <div>
          <div className="border rounded-lg p-6 bg-white shadow-sm">
            ...
            <button className="mt-6 border border-slate-300 w-full text-black py-2 rounded hover:bg-slate-100 transition">Save Preferences</button>
          </div>
        </div>
      </div>
    </div>
