      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          <div className="border rounded-lg p-6 bg-white shadow-sm">
            ...
            <button className="bg-[#ffc01d] text-black px-4 py-2 rounded hover:bg-black hover:text-white transition">Save Changes</button>
          </div>
          ...
          <div className="border rounded-lg p-6 bg-white shadow-sm">
            ...
            <div className="mb-4">
              ...
              <button className="border bg-[#ffc01d] text-black border-slate-300 px-4 py-2 rounded hover:bg-black  transition">Enable 2FA</button>
            </div>

            <button className="bg-black text-white px-4 py-2 rounded hover:bg-[#ffc01d] hover:text-white transition">Update Password</button>
          </div>
        </div>
        ...
        <div>
          <div className="border rounded-lg p-6 bg-white shadow-sm">
            ...
            <button className="mt-6 border border-slate-300 w-full text-black py-2 rounded hover:bg-slate-400 transition">Save Preferences</button>
          </div>
        </div>
      </div>
    </div>
