    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600 mt-1">Communicate with Principal and students</p>
        </div>
        <button className="flex items-center px-4 py-2 bg-[#ffc01d] text-black rounded-md hover:bg-black hover:text-white ">
